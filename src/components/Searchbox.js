    ...
    <>
      <div className="relative text-gray-600 w-1/2">
        ...
        <Link to={`/search?q=${searchValue}`}
          type="submit"
          className="hidden sm:flex absolute justify-center items-center	 right-0 top-0 h-full rounded-full hover:bg-gray-300 ml-4 px-4 hover:text-gray-800 "
        >
          <svg
            className="h-4 w-4 fill-current flex justify-center items-center"
            version="1.1"
            id="Capa_1"
            x="0px"
            y="0px"
                ...
                >
                  <div className="relative text-gray-600">
                    ...
                    <Link
                      ...
                      type="submit"
                      className=" absolute flex items-center right-0 top-0 h-full rounded-full hover:bg-gray-300 ml-4 px-4 hover:text-gray-800 "
                    >
                      <svg
                        className="h-4 w-4 fill-current"
                        version="1.1"
