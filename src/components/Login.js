...
function Login() {
  ...
  return (
    <div>
      ...
      />
      <body>
        <section className="min-h-screen flex items-stretch text-white h-screen bg-gray-800">
          <div className="lg:flex w-1/2 hidden bg-gray-900 bg-no-repeat bg-cover relative items-center">
            <div className="absolute bg-gray-900 opacity-60 inset-0 z-0"></div>
          ...
          <div
            ...
            style={{ backgroundColor: "rgb(0 3 28)" }}
          >
            <div
              className="absolute lg:hidden z-10 inset-0 bg-gray-900 bg-no-repeat bg-cover items-center"
              style={{
                backgroundImage:
